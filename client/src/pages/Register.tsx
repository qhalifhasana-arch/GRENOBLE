    ...
    <div className="min-h-screen bg-gradient-to-b from-green-950 via-green-900 to-emerald-950" data-testid="register-page">
      <div className="relative w-full h-40 sm:h-48 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <h1 className="text-2xl sm:text-3xl font-black text-white tracking-tight drop-shadow-lg">GreenHarvest</h1>
          ...
          {!selectedCountry ? (
            <div>
              ...
              <div className="grid grid-cols-2 gap-3" data-testid="country-grid">
                {COUNTRIES.map((country) => (
                  <button
                    ...
                    className="bg-green-800/50 border-2 border-green-600/30 hover:bg-green-700/60 hover:border-green-500/50 rounded-2xl p-4 flex flex-col items-center gap-1.5 transition-colors active:scale-95"
              ...
              <div className="text-center mt-5">
                <Link href="/login">
                  <span className="text-sm text-green-300/60 hover:text-green-200 cursor-pointer" data-testid="link-login">
              ...
              <form onSubmit={handleSubmit} className="bg-green-800/40 rounded-2xl p-5 border border-green-600/20 space-y-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="relative flex-1">
                      <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-green-400/60" />
                      <input
                        type="tel"
                        value={phoneNumber}
                ...
                <div>
                  ...
                  <div className="relative">
                    <KeyRound className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-green-400/60" />
                    <input
                      type="password"
                      value={password}
                ...
                <div>
                  ...
                  <div className="relative">
                    <UserCircle className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-green-400/60" />
                    <input
                      type="text"
                      value={referralCode}
                ...
                <Button
                  type="submit"
                  className="w-full h-[52px] bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white rounded-xl text-base font-bold shadow-lg shadow-green-900/40 mt-1 transition-all active:scale-[0.98]"
